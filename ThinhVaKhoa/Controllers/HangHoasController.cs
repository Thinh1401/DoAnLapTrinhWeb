...
namespace ThinhVaKhoa.Controllers
{
    ...
    {
        private readonly ThinhVaKhoaContext _context;

        public HangHoasController(ThinhVaKhoaContext context)
        {
            _context = context;
        }
        ...
        {
            var ThinhVaKhoaContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await ThinhVaKhoaContext.ToListAsync());
        }
